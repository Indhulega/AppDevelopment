    ...
    <div className="dashboard">
      <div className="sidebar">
        ...
        <div className="sidebar-links">
          ...
          <div onClick={() => {navigate('saved');handleblur()}}className='tabs'>Saved</div>
          
          
          
          <div onClick={() => {navigate('/login'); handleblur()}} className='tabs'>Logout</div>
          <div onClick={() =>{navigate('/login'); handleblur()}} className='tabs'>Admin</div>
        </div>
      </div>
